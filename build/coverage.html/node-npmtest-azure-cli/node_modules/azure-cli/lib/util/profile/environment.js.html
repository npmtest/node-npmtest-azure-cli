...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure-cli/node_modules/azure-cli/lib/util/profile/environment.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure-cli/node_modules/azure-cli/lib/util/profile/environment.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure-cli/node_modules/azure-cli/lib/util/profile/</a> &#187; environment.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        return _.chain(Environment.publicEnvironments).pluck('name').contains(this.name).value();</span>
      }
    },
&nbsp;
    values: {
      enumerable: false,
      configurable: false,
      get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return values; </span>}
    }
  });
}
&nbsp;
...
_.extend(EnvironmentParameter.prototype, {
  propertyDescriptor: function (env) {
    ...
    return {
      ...
      configurable: false,
      get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        var val = process.env[self.environmentVariable] || env.values[self.name];</span>
...
<span class="cstat-no" title="statement not covered" >        return val;</span>
      ...
      set: <span class="fstat-no" title="function not covered" >function (value) {</span> <span class="cstat-no" title="statement not covered" >this.values[self.name] = value; </span>}
    };
  },
});
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function addRealm(targetUrl, realm) {</span>
<span class="cstat-no" title="statement not covered" >  if (realm) {</span>
<span class="cstat-no" title="statement not covered" >    var urlObj = url.parse(targetUrl, true);</span>
<span class="cstat-no" title="statement not covered" >    delete urlObj.search;</span>
<span class="cstat-no" title="statement not covered" >    urlObj.query.whr = realm;</span>
<span class="cstat-no" title="statement not covered" >    targetUrl = url.format(urlObj);</span>
  }
<span class="cstat-no" title="statement not covered" >  return targetUrl;</span>
}
&nbsp;
_.extend(Environment.prototype, {
  getPortalUrl: <span class="fstat-no" title="function not covered" >function (realm) {</span>
<span class="cstat-no" title="statement not covered" >    return addRealm(this.portalUrl, realm);</span>
  },
&nbsp;
  getPublishingProfileUrl: <span class="fstat-no" title="function not covered" >function (realm) {</span>
<span class="cstat-no" title="statement not covered" >    return addRealm(this.publishingProfileUrl, realm);</span>
  },
&nbsp;
  toJSON: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    return _.extend({ name: this.name }, this.values);</span>
  },
&nbsp;
  getAuthConfig: <span class="fstat-no" title="function not covered" >function (tenantId, resourceId) {</span>
<span class="cstat-no" title="statement not covered" >    if (!tenantId) {</span>
<span class="cstat-no" title="statement not covered" >      tenantId = constants.AAD_COMMON_TENANT;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (!resourceId) {</span>
<span class="cstat-no" title="statement not covered" >      resourceId = this.activeDirectoryResourceId;</span>
    }
...
&nbsp;
  isDefaultEnv: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    return this.name === DEFAULT_ENV_NAME;</span>
  }
});
&nbsp;
